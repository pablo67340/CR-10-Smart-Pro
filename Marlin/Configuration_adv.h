...
#define DISABLE_IDLE_Z false  // Set to false if the nozzle will fall down on your printed part when print has finished.
...
// G2/G3 Arc Support
//
#define ARC_SUPPORT                 // Enable ARC_SUPPORT to use G2/G3 commands
